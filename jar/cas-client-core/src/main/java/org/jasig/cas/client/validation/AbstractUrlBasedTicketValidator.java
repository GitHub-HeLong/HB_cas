...
public abstract class AbstractUrlBasedTicketValidator implements TicketValidator {
     ...
     */
    protected final String constructValidationUrl(final String ticket, final String serviceUrl,final String clientIp) {
        final Map<String, String> urlParameters = new HashMap<String, String>();

        logger.debug("Placing URL parameters in map.");
        urlParameters.put("ticket", ticket);
        urlParameters.put("clientIp", clientIp);
        urlParameters.put("service", serviceUrl);
        logger.info("the clientIp is {}.",clientIp);
        if (this.renew) {
    ...
    public final Assertion validate(final String ticket, final String service,final String clientIp) throws TicketValidationException {
        final String validationUrl = constructValidationUrl(ticket, service,clientIp);
        logger.debug("Constructing validation url: {}", validationUrl);
        logger.info("Constructing validation url: {}", validationUrl);
        logger.info("Constructing validation ticket: {}", ticket);
        try {

...
public final class DefaultTicketRegistryCleaner implements RegistryCleaner {
    ...
    private Integer intervalCleanTicket = 1;
    
    public Integer getIntervalCleanTicket() {
		return intervalCleanTicket;
	}


	public void setIntervalCleanTicket(Integer intervalCleanTicket) {
		this.intervalCleanTicket = intervalCleanTicket;
	}
	...
	public DefaultTicketRegistryCleaner(Integer intervalCleanTicket) {
		super();
		this.intervalCleanTicket = intervalCleanTicket;
		/*Timer timer = new Timer(); 
	    timer.schedule(new TimerTask() {  
            public void run() {  
            	logger.info("clean ticket start.");
                clean();
            }  
        },5000, 60 * 1000 * intervalCleanTicket);*/
	    logger.info("DefaultTicketRegistryCleaner intervalCleanTicket {}",intervalCleanTicket);
	}
    ...
    public void clean() {
        ...
        try {
            ...
            for (final Ticket ticket : ticketsToRemove) {
            	...
            	logger.info("remove ticket,the ticketId is {}.", ticket.getId());

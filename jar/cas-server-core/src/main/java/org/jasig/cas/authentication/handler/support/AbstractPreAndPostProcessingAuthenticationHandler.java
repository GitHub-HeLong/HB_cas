...
public abstract class AbstractPreAndPostProcessingAuthenticationHandler extends AbstractAuthenticationHandler {
    ...
    public final HandlerResult authenticate(final Credential credential)
    	...
    	logger.info("AbstractPreAndPostProcessingAuthenticationHandler the credential is {}",credential);
    ...
    public abstract boolean updateUserOnlineState(Integer state,String userName);
    
    public abstract boolean updateUserLoginTime(Date date,String userName);
